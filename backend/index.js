...
app.use(
  session({ secret: "farhansapp", resave: false, saveUninitialized: false, cookie: { sameSite:"none",secure:true, domain: "friends-only-frontend.vercel.app", path:"/" }, name: "cookie" })
);
